...
public class ChooseToggleGroupBot : MonoBehaviour {
    ...
    public void OnClickChooseBot()
    {
        if (currentSelection != null)
        {
            ...
            + PlayerActor.localPlayerGameObject.GetComponent<UseTeleport>().playerID + "," + "ConfirmedBot" + ","
            + PlayerActor.localPlayerGameObject.name + ","
	...
	void Start () {
        ...
        switch (PlayerActor.localPlayerGameObject.name)
        {
